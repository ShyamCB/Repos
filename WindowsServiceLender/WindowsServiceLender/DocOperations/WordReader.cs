...
using static WindowsServiceLender.Models.DocumentField;
using WindowsServiceLender.Model;
...
namespace WindowsServiceLender.DocOperations
{
    public class WordReader
    {
        ...
        public string FillValuesToDoc1(byte[] fileString, string tableStrXML, List<DocValues> docVal)
        {
        ...
        public string FillValuesToDoc(byte[] fileString, string tableStrXML, SendDocumentInfo sDocInfo)
        {
            ...
            List<DocValues> docVal = sDocInfo.DocuSignFields;
            List<TableValue> tblDocVal = new List<TableValue>();
            if (!string.IsNullOrEmpty(tableStrXML))
            {
        ...
        private byte[] SetMultipleWordDataFromPlaceHolder(byte[] fileBytes, List<DocValues> value, List<TableValue> tblDocVal)
        {
        ...
        private void SetValueToTable(MainDocumentPart mainDocumentPart, List<TableValue> tblDocVal)
        {
